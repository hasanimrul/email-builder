    ...
    >
      ...
      >
        ...
        >
          <Box px={2}>
            <Tabs
              value={selectedLeftSidebarTab}
              onChange={(_, v) => setLeftSidebarTab(v)}
            >
        ...
        >
          {selectedLeftSidebarTab == "components" && (
            <div style={{ width: "210px" }}>
              <Typography variant="h6" component="p" sx={{ p: 0.1 }}>
                Drag and drop components into canvas to customize.
              </Typography>
          ...
          {selectedLeftSidebarTab == "templates" && (
            ...
            >
              <Stack>
                ...
                <SidebarButton href="#sample/autosaved">
                  Recently edited canvas
                </SidebarButton>
              </Stack>
